<?php include "header.php"; ?>
        <!-- ***** Welcome Area Start ***** -->
        <section id="home" class="section welcome-area bg-success overflow-hidden d-flex align-items-center">
            <div class="container">
...
?>
                    ...
                    <div class="col-12 col-md-5">
                        ...
                        <div class="">
                            <span class="">
                                <img class="welcome-animation d-block ml-auto" src="assets/img/welcome/background.jpg" alt="">
                            </span>
